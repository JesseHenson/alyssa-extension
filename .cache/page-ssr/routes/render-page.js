...
var _react = _interopRequireDefault(__webpack_require__(8980));
...
const React=__webpack_require__(8980);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(3946);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
module.exports = require("/Users/jessehenson/Desktop/Projects/alyssa-extension/.cache/ssr-builtin-trackers/fs");
...
var React = __webpack_require__(8980);
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var _react=_interopRequireDefault(__webpack_require__(8980));var _styledComponents=__webpack_require__(7131);var sheetByPathname=new Map();// eslint-disable-next-line react/prop-types,react/display-name
...
var React = _interopRequireWildcard(__webpack_require__(8980));
...
var _react = __webpack_require__(8980);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(8980),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/jessehenson/Desktop/Projects/alyssa-extension/node_modules/react-dom/server.js");
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var React=_interopRequireWildcard(__webpack_require__(8980));var _gatsby=__webpack_require__(123);var _common=__webpack_require__(1854);var _getManifestPathname=_interopRequireDefault(__webpack_require__(4598));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
exports.components={"component---src-pages-affirmation-demo-js":()=>__webpack_require__.e(/* import() | component---src-pages-affirmation-demo-js */ 775).then(__webpack_require__.bind(__webpack_require__, 5983)),"component---src-pages-cosmic-tab-js":()=>__webpack_require__.e(/* import() | component---src-pages-cosmic-tab-js */ 499).then(__webpack_require__.bind(__webpack_require__, 9011)),"component---src-pages-demos-js":()=>__webpack_require__.e(/* import() | component---src-pages-demos-js */ 149).then(__webpack_require__.bind(__webpack_require__, 2343)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 293).then(__webpack_require__.bind(__webpack_require__, 5631)),"component---src-pages-roadmap-js":()=>__webpack_require__.e(/* import() | component---src-pages-roadmap-js */ 337).then(__webpack_require__.bind(__webpack_require__, 6043)),"component---src-pages-settings-js":()=>__webpack_require__.e(/* import() | component---src-pages-settings-js */ 854).then(__webpack_require__.bind(__webpack_require__, 9954)),"component---src-pages-themes-js":()=>__webpack_require__.e(/* import() | component---src-pages-themes-js */ 537).then(__webpack_require__.bind(__webpack_require__, 3657)),"component---src-pages-upgrade-js":()=>__webpack_require__.e(/* import() | component---src-pages-upgrade-js */ 53).then(__webpack_require__.bind(__webpack_require__, 7431))};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8980);
...
"use strict";
module.exports = require("/Users/jessehenson/Desktop/Projects/alyssa-extension/node_modules/react/index.js");
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(6560),options:{"plugins":[]}},{name:'gatsby-plugin-styled-components',plugin:__webpack_require__(3203),options:{"plugins":[],"displayName":true,"fileName":true,"minify":true,"namespace":"","transpileTemplateLiterals":true,"topLevelImportPaths":[],"pure":false,"disableVendorPrefixes":false}},{name:'gatsby-plugin-image',plugin:__webpack_require__(70),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(4858),options:{"plugins":[],"name":"Cosmic Tab Coach","short_name":"CosmicTab","start_url":"/","background_color":"#667eea","theme_color":"#764ba2","display":"minimal-ui","icon":"src/images/cosmic-icon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"224eea374e42d318647ad0be728c3d93"}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/******/ 			return "" + {"53":"component---src-pages-upgrade-js","149":"component---src-pages-demos-js","293":"component---src-pages-index-js","337":"component---src-pages-roadmap-js","499":"component---src-pages-cosmic-tab-js","537":"component---src-pages-themes-js","775":"component---src-pages-affirmation-demo-js","854":"component---src-pages-settings-js"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(8980);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(3946);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(2015);const{WritableAsPromise}=__webpack_require__(7227);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(988);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
